...
class ModelLoaderExtension extends MultiModelExtensionBase {
  ...
  loadModel (dbModel) {
    return new Promise(async (resolve) => {
      ...
      switch (dbModel.env) {
        case 'FluentProduction':
          const lmvProxy =
            dbModel.model.proxy || 'lmv-proxy-2legged'

          console.log(Autodesk.Viewing.endpoint.getEndpointAndApi())
          ...
          var documentId = "urn:" + dbModel.model.urn;
          //this.viewer.loadDocument(documentId, onDocumentLoadSuccess, onDocumentLoadFailure);
          ...
          //       })
          //       resolve(i);
          //       this.viewer.impl.setFPSTargets(12,20,24);
          //       this.viewer.disableHighlight(true);
          //       this.viewer.autocam.shotParams.destinationPercent=2;
