...
class Viewer extends React.Component {
  ...
  componentDidMount () {
    var options = {
      ...
      api: 'fluent',  // for models uploaded to EMEA change this option to 'derivativeV2_EU'
      ...
      getAccessToken: function(onTokenReady) {
        ...
        $.get('/api/forge/token/3legged', (res) => {
          ...
          this.timeInSeconds = res.expires_in; // Use value provided by Forge Authentication (OAuth) API
        }).then(() => {
          onTokenReady(this.token, this.timeInSeconds);
        });
      }
    };
    ...
    Autodesk.Viewing.Initializer(options, () => {
      ...
      viewer.container.appendChild(this.panelsContainer)
      // add viewer to props
